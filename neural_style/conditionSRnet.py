...
import utils
import draw
from LRnet import condition_TransformerNet,create_condition
import visdom
...
def train(args):
    ...
    transformer = condition_TransformerNet(args.mode, resblock_num=args.resblobk_num, IN_flag=True, deconv_mode=args.deconv_mode)
    ...
    for e in range(args.epochs):
        ...
        for batch_id, (x_HR, x_LR, x_params) in enumerate(train_loader):
            ...
            x_gen = transformer(x_LR,x_condition).clamp(0, 255)
